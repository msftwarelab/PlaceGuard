...
PLACES_DB: dict[str, dict] = {
    ...
    "285-west-rooftop-nyc": {
        "id": "285-west-rooftop-nyc",
        "name": "285 West Rooftop Bar",
        "category": "Rooftop Bar",
        "city": "New York",
        "country": "US",
        "address": "285 W Broadway, New York, NY 10013",
        "hours": "Mon-Sun 5PM-2AM",
        "price_tier": "$$$",
        "average_rating": 4.4,
        "review_count": 3120,
        "reviews_summary": "Great Manhattan skyline views, strong cocktails, lively crowd",
        "operating": True,
        "verified": True,
        "safety_score": 0.91,
        "tourist_friendly": True,
        "last_updated": (datetime.utcnow() - timedelta(days=3)).isoformat(),
        "coordinates": {"lat": 40.7219, "lng": -74.0051},
        "tags": ["rooftop", "cocktails", "nyc", "manhattan", "views", "trendy"],
        "price_range": {"min_usd": 18, "max_usd": 28},
    },
    "nobu-malibu": {
        "id": "nobu-malibu",
        "name": "Nobu Malibu",
        ...
        "average_rating": 4.7,
        "review_count": 5840,
        "reviews_summary": "Iconic oceanfront dining, world-class sushi, celebrity hotspot",
        "operating": True,
        "verified": True,
        "safety_score": 0.96,
        "tourist_friendly": True,
        "last_updated": (datetime.utcnow() - timedelta(days=4)).isoformat(),
        "coordinates": {"lat": 34.0354, "lng": -118.6789},
        "tags": ["fine dining", "sushi", "malibu", "oceanfront", "luxury", "reservation required"],
        "price_range": {"min_usd": 90, "max_usd": 250},
    },
    "franklin-bbq-austin": {
        "id": "franklin-bbq-austin",
        "name": "Franklin Barbecue",
        "category": "BBQ Restaurant",
        "city": "Austin",
        "country": "US",
        "address": "900 E 11th St, Austin, TX 78702",
        "hours": "Tue-Sun 11AM-3PM (or until sold out)",
        "price_tier": "$$",
        "average_rating": 4.8,
        "review_count": 12400,
        "reviews_summary": "Best brisket in America, expect long lines, worth every minute",
        "operating": True,
        "verified": True,
        "safety_score": 0.93,
        "tourist_friendly": True,
        "last_updated": (datetime.utcnow() - timedelta(days=1)).isoformat(),
        "coordinates": {"lat": 30.2700, "lng": -97.7298},
        "tags": ["bbq", "brisket", "austin", "texas", "iconic", "long lines"],
        "price_range": {"min_usd": 20, "max_usd": 50},
    },
    "grand-aurora-chicago-fake": {
        # Does not exist — tests hallucination detection for US places
        "id": "grand-aurora-chicago-fake",
        "name": "Grand Aurora Steakhouse",
        "category": "Steakhouse",
        "city": "Chicago",
        "country": "US",
        "address": None,
